function renderStatusBadge(status) {
  const map = {
    ...
    READY_TO_APPLY: "bg-blue-100 text-blue-700 border-blue-200", READY_FOR_WORKER: "bg-blue-100 text-blue-700 border-blue-200", IN_PROGRESS: "bg-sky-100 text-sky-700 border-sky-200",
    NEEDS_REVIEW: "bg-amber-100 text-amber-800 border-amber-200", SUBMITTED: "bg-emerald-100 text-emerald-700 border-emerald-200",
    SKIPPED: "bg-slate-100 text-slate-700 border-slate-200", ABORTED: "bg-slate-100 text-slate-700 border-slate-200", FAILED: "bg-red-100 text-red-700 border-red-200", BLOCKED: "bg-red-100 text-red-700 border-red-200",
